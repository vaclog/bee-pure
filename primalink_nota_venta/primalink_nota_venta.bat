...
set FILE_RUN=C:\Users\ValkUser\Documents\NOTA_VENTA\bee-pure\primalink_nota_venta\
...
python "%FILE_RUN%\main.py"  >> C:\LOGS\primalink_nota_venta_%FILENAMELOG%.txt 2>&1