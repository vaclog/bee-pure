...
set FILE_RUN=C:\Users\ValkUser\Documents\NOTA_VENTA\bee-pure\microbel_nota_venta\
...
python "%FILE_RUN%\main.py"  >> C:\LOGS\microbel_nota_venta_%FILENAMELOG%.txt 2>&1